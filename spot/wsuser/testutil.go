...
func (m *mockHandlerRouter) Route(msg *PushDataV3UserWrapper) {
}
...
func (m *mockSubscription) acceptEvent(msg *PushDataV3UserWrapper) bool {
	return false
}

func (m *mockSubscription) handleEvent(msg *PushDataV3UserWrapper) {}
