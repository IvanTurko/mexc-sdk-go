...
func (m *mockHandlerRouter) Route(msg *PushDataV3MarketWrapper) {
}
...
func (m *mockSubscription) acceptEvent(msg *PushDataV3MarketWrapper) bool {
	return false
}

func (m *mockSubscription) handleEvent(msg *PushDataV3MarketWrapper) {}

func (m *mockSubscription) id() string {
	return m.StreamName
}

func (m *mockSubscription) params() any {
	return m.StreamName
}
