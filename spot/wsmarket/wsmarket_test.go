...
func TestWSMarket_Connect_Failure(t *testing.T) {
	ws := &WSMarket{
...
func TestWSMarket_Close_Idempotent(t *testing.T) {
	client := &testutil.MockClient{}
	ws := &WSMarket{client: client}
...
func TestWSMarket_Subscribe(t *testing.T) {
	...
	t.Run("successful subscription", func(t *testing.T) {
		...
		ws := &WSMarket{
			client:      &testutil.MockClient{},
			router:      router,
			counter:     &testutil.MockCounter{IncValue: id},
...
func TestWSMarket_sendAndAwaitResponse(t *testing.T) {
	t.Run("successful response", func(t *testing.T) {
		...
		require.NoError(t, err)
		require.Len(t, ws.promisesMap, 0)
	})
